...
- **N2.2** Known data gaps are surfaced in the UI, not hidden: unscored 2010–2015 seasons,
  ...
  team/week) render as explicit "not available" affordances, never as zeros masquerading as
  data. DST is now scored end-to-end, so it shows real points where a row exists.
