...
| **UP** | Upstream / Phase-1 program & research (NOT dashboard PRs) | data (pipeline) + research | runs alongside | F-27 (data half ✅ landed → F-51), F-25, F-37 (tier 2), F-06, F-49, ~~F-50~~ ✅ regen, F-52 | ☐ | per-program handoffs in `docs/handoffs/` |
