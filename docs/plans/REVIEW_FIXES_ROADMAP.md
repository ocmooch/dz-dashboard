...
| **P2** | Data honesty & affordance precision (+ gap-validation harness) | gap-affordance + tests | soft: P1 (week semantics) | F-16, F-35, F-26, F-33, F-48, F-43 | ◐ (VERIFY done; **PR #31** open → dev) | `docs/plans/fix-P2-honesty.md` |
